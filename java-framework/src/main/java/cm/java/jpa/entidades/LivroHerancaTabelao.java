...
public class LivroHerancaTabelao extends ItemHerancaTabelao {
  ...
  public LivroHerancaTabelao() {
  }

  public LivroHerancaTabelao(String tituloParam, Float precoParam, String descricaoParam, String isbnParam, String editoraParam, Integer nroDePaginasParam, Boolean ilustracoesParam) {
